              ...
              <li
                ...
                <button
                  ...
                  <div className="ml-2 flex shrink-0 items-center space-x-2">
                    ...
                    {prompt.shortcut && (
                      <span className="inline-flex h-5 max-w-[80px] items-center rounded-full border border-secondary px-2 py-0.5 text-xs font-medium text-black dark:text-white">
