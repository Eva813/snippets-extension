...
const FormRoot = () => {
  ...
  return (
    <>
      <div
        className="dark flex h-screen max-h-screen flex-col justify-between bg-gray-700 text-white"
        ...
        <div className="flex items-center justify-end gap-2.5 rounded bg-gray-800 p-5 text-white shadow-md">
